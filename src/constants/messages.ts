export const MESSAGE = {
    ...
    USER: {
        ...
        CANNOT_UPDATE_PASSWORD_OF_DELETED_USER: "Cannot update password of a deleted user",
        CANNOT_UPDATE_EMAIL_OF_DELETED_USER: "Cannot update email of a deleted user",
        INVALID_CURRENT_PASSWORD: "Invalid current password",
        NEW_PASSWORD_CANNOT_BE_SAME_AS_OLD_PASSWORD: "New password cannot be same as old password",
        EMAIL_MUST_BE_DIFFERENT_FROM_CURRENT_EMAIL: "Email must be different from current email",
